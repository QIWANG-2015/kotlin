...
class CandidateResolver(
    ...
    private fun CallCandidateResolutionContext<*>.checkVisibilityNoReceiver() = checkAndReport {
        checkVisibilityWithDispatchReceiver(null, null)
    }
    ...
    private fun <D : CallableDescriptor> checkReceivers(context: CallCandidateResolutionContext<D>): ResolutionStatus {
        ...
        if (!context.isDebuggerContext
                ...
                && context.isCandidateVisible(receiverArgument = null, smartCastType = null)) {
    ...
    private fun <D : CallableDescriptor> CallCandidateResolutionContext<D>.checkReceiver(
        ...
        val smartCastNeeded =
                !ArgumentTypeResolver.isSubtypeOfForArgumentType(receiverArgument.type, expectedReceiverParameterType)
                || !isCandidateVisibleOrExtensionReceiver(receiverArgument, null, isDispatchReceiver)
