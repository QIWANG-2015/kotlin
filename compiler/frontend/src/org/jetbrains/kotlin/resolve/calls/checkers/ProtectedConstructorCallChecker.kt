...
object ProtectedConstructorCallChecker : CallChecker {
    override fun check(resolvedCall: ResolvedCall<*>, context: BasicCallResolutionContext) {
        ...
        if (!Visibilities.isVisibleWithNonExistingReceiver(descriptor, scopeOwner)) return
        ...
        // Using ERROR_IF_PROTECTED helps us to check that descriptor doesn't meet conditions of java package/static-protected
        ...
        if (Visibilities.findInvisibleMember(Visibilities.ERROR_IF_PROTECTED, descriptor, scopeOwner) == descriptor) {
